...
skew.plot(lcl_pressure, lcl_temperature, 'ko', markerfacecolor='black', alpha = 0) #alpha = 0 make dot transparents
...
skew.plot_mixing_lines( p = np.linespace(400, max(skew.ax.get_ylim())) * units.mbar )
